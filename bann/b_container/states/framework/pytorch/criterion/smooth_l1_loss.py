...
@final
@dataclass
class _SmoothL1LossStateKwargs(CriterionKwargs):
...
@final
class SmoothL1LossState(CriterionState[_SmoothL1LossStateKwargs]):

    def __init__(self) -> None:
        super().__init__()
        self.__kwargs: Optional[_SmoothL1LossStateKwargs] = None

    def get_kwargs_repr(self) -> str:
        return dict_json_repr(self.get_kwargs().__dict__, self.get_pre_arg())

    def get_kwargs(self) -> _SmoothL1LossStateKwargs:
    ...
    def set_kwargs(self, args_dict: Dict, /) -> None:
        ...
        self.__kwargs = super().parse_dict(_SmoothL1LossStateKwargs, args_dict)


_SmoothL1LossStateTypes: Final[Dict[str, Tuple[Callable[[str], object], str]]] = {
...
def get_smooth_l1_loss_state_types() -> Dict[str, Tuple[Callable[[str], object], str]]:
    return _SmoothL1LossStateTypes
