...
from typing import Optional, Tuple, Dict, Callable, final, Final
...
@final
@dataclass
class _NLLLossStateKwargs(CriterionKwargs):
...
@final
class NLLLossState(CriterionState[_NLLLossStateKwargs]):

    def __init__(self) -> None:
        super().__init__()
        self.__kwargs: Optional[_NLLLossStateKwargs] = None

    def get_kwargs_repr(self) -> str:
        return dict_json_repr(self.get_kwargs().__dict__, self.get_pre_arg())

    def get_kwargs(self) -> _NLLLossStateKwargs:
    ...
    def set_kwargs(self, args_dict: Dict, /) -> None:
        ...
        self.__kwargs = super().parse_dict(_NLLLossStateKwargs, args_dict)


_NLLLossStateTypes: Final[Dict[str, Tuple[Callable[[str], object], str]]] = {
...
def get_nll_loss_state_types() -> Dict[str, Tuple[Callable[[str], object], str]]:
    return _NLLLossStateTypes
