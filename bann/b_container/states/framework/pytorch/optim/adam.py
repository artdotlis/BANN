...
@final
@dataclass
class _ADAMStateKwargs(OptimStateKwargs):
    lr: float = 0.0001
...
@final
class ADAMState(MainOptimSt[_ADAMStateKwargs], PerParameterAbc):

    def __init__(self) -> None:
        super().__init__()
        self.__kwargs: Optional[_ADAMStateKwargs] = None
    ...
    def get_kwargs(self) -> _ADAMStateKwargs:
...
_ADAMStateTypes: Final[Dict[str, Tuple[Callable[[str], object], str]]] = {
...
def get_adam_state_types() -> Dict[str, Tuple[Callable[[str], object], str]]:
    return _ADAMStateTypes
